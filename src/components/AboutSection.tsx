    ...
    >
      <div className="max-w-[1240px] mx-auto px-6 sm:px-8">
        ...
        <div className="flex items-center gap-3 text-xs font-mono-code text-stone-500 uppercase tracking-widest mb-8">
          <span className="text-emerald-800 font-semibold">[ 01 ]</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            <h2 className="font-editorial text-3xl sm:text-4xl lg:text-[40px] text-stone-900 leading-[1.18]">
              Microbiological precision applied to pharmaceutical assurance & environmental systems.
            </h2>
            <p className="text-sm text-stone-500 font-mono-code">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-stone-200/80 bg-stone-100 shadow-[0_2px_8px_rgba(0,0,0,0.03)] group">
              ...
              <div className="absolute bottom-0 inset-x-0 bg-stone-950/80 backdrop-blur-xs text-white p-3.5 flex items-center justify-between text-xs font-mono-code">
                ...
                <span className="text-stone-400 text-[11px]">BSL-2 Lab Protocol</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-base sm:text-lg text-stone-700 font-light leading-relaxed">
                Currently based in Germany, he is pursuing a Master of Science in <strong className="font-normal text-stone-900">Environmental and Resource Management</strong> at <strong className="font-normal text-stone-900">Brandenburg University of Technology (BTU Cottbus-Senftenberg)</strong>, bridging laboratory-grade diagnostic rigor with sustainable resource stewardship.
              </p>
            </div>

            {/* Core Competency Highlights in minimal editorial format */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-6 border-t border-stone-200/60">
            ...
            <div className="p-4 rounded-xl bg-stone-100/70 border border-stone-200/80 flex items-start gap-3">
