    ...
    >
      <div className="max-w-[1240px] mx-auto px-6 sm:px-8">
        ...
        <div className="flex items-center gap-3 text-xs font-mono-code text-black/80 uppercase tracking-widest mb-8 font-medium">
          <span className="text-emerald-800 font-bold">[ 04 ]</span>
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-black/15 bg-black/[0.03] shadow-md shadow-black/5 group">
              ...
              <div className="absolute bottom-0 inset-x-0 bg-black/85 backdrop-blur-xs text-white p-3 flex items-center justify-between text-xs font-mono-code">
                ...
                <span className="text-white/80 text-[10px]">BTU Cottbus & DU</span>
              </div>
            </div>
          </div>

          {/* Right Column: Minimal Academic Timeline */}
          <div className="lg:col-span-7 relative border-l border-emerald-300 pl-6 sm:pl-8 space-y-10">
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap items-center gap-3 text-xs font-mono-code text-black/80 font-medium">
                    <span className="text-emerald-800 font-bold bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200">{edu.period}</span>
                    <span>•</span>
                  ...
                  {edu.thesis && (
                    <div className="mt-2.5 p-3 rounded-lg bg-emerald-50 border border-emerald-200 text-xs text-black/90 font-normal leading-relaxed">
                      <span className="font-mono-code text-emerald-800 font-bold uppercase tracking-wider block mb-1">
                        Thesis Focus
                      </span>
                      {edu.thesis}
                    </div>
