    ...
    >
      <div className="max-w-[1240px] mx-auto px-6 sm:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 relative border-l border-stone-200 pl-6 sm:pl-8 space-y-12">
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap items-center gap-3 text-xs font-mono-code text-stone-500">
                    <span className="text-emerald-800 font-semibold">{exp.period}</span>
                    <span>•</span>
                  ...
                  <div className="flex flex-wrap gap-2 pt-1">
                    {exp.tags.map((tag) => (
                      <span
                        key={tag}
                        className="inline-block text-[11px] font-mono-code text-stone-600 bg-stone-100/90 border border-stone-200/70 px-2.5 py-0.5 rounded"
                      >
                        {tag}
                      </span>
                    ))}
